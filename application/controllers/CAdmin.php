...
class CAdmin extends CI_Controller
{
    ...
    public function index()
    {
        if (isset($_SESSION['id_user'])) {
            ...
            $this->load->view('headfoot/navbar_dash_admin', $data);
    ...
    public function rencana_perjadin($id)
    {
        if (isset($_SESSION['id_user'])) {
            ...
            $this->load->view('headfoot/header', $data);
            $this->load->view('headfoot/navbar_dash_admin', $data);
            $this->load->view('admin/rencana_perjadin', $data);
            $this->load->view('headfoot/footer', $data);
        } else {
            redirect('CLogin/logout');
        }
    ...
    public function detail_rencana($id)
    {
        if (isset($_SESSION['id_user'])) {
            ...
            $this->load->view('headfoot/header', $data);
            $this->load->view('headfoot/navbar_dash_admin', $data);
            $this->load->view('admin/detail_rencana', $data);
            $this->load->view('headfoot/footer', $data);
        } else {
            redirect('CLogin/logout');
        }
    ...
    public function tambah_laporan($id)
    {
        if (isset($_SESSION['id_user'])) {
            ...
            echo "<script>alert('Anda berhasil menambah data');</script>";
            redirect('CAdmin/detail_rencana/' . $id, 'refresh');
        } else {
            redirect('CLogin/logout');
        }
    }
    ...
    public function tambah_rencana_perjadin()
    {
        if (isset($_SESSION['id_user'])) {
            ...
            if ($this->form_validation->run() == FALSE) {
                $this->load->view('headfoot/header', $data);
                $this->load->view('headfoot/navbar_dash_admin', $data);
                $this->load->view('admin/tambah_rencana_perjadin', $data);
            } else {
                $this->admin_model->proses_tambah_rencana();
                echo "<script>alert('Anda berhasil menambah data');</script>";
                redirect('CAdmin/rencana_perjadin/' . $_SESSION['id_user'], 'refresh');
            }
        } else {
            redirect('CLogin/logout');
        }
    ...
    public function edit_rencana1($id)
    {
        if (isset($_SESSION['id_user'])) {
            ...
            if ($this->form_validation->run() == FALSE) {
                $this->load->view('headfoot/header', $data);
                $this->load->view('headfoot/navbar_dash_admin', $data);
                $this->load->view('admin/edit_kelola', $data);
            } else {
                $this->admin_model->proses_edit_rencana();
                echo "<script>alert('Anda berhasil mengedit data');</script>";
                redirect('CAdmin/kelola_perjadin/', 'refresh');
            }
        } else {
            redirect('CLogin/logout');
        }
    ...
    public function hapus_rencana1($id)
    {
        if (isset($_SESSION['id_user'])) {
    ...
    public function riwayat_perjadin()
    {
        if (isset($_SESSION['id_user'])) {
            ...
            $this->load->view('headfoot/header', $data);
            $this->load->view('headfoot/navbar_dash_admin', $data);
            $this->load->view('admin/riwayat_perjadin', $data);
            $this->load->view('headfoot/footer', $data);
        } else {
            redirect('CLogin/logout');
        }
    ...
    public function tambah_kegiatan()
    {
        if (isset($_SESSION['id_user'])) {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                echo "<script>alert('Anda berhasil menambah data');</script>";
                redirect('CAdmin/kegiatan', 'refresh');
            }
        } else {
            redirect('CLogin/logout');
        }
    ...
    //KELOLA PERJADIN
    public function kelola_perjadin()
    {
        if (isset($_SESSION['id_user'])) {
            $data['title'] = "Kelola Perjadin";
            $data['notif'] = $this->admin_model->hitungNew();
            $data['rencana'] = $this->admin_model->getRiwayat();
            $this->load->view('headfoot/header', $data);
            $this->load->view('headfoot/navbar_dash_admin', $data);
            $this->load->view('admin/kelola_perjadin', $data);
            $this->load->view('headfoot/footer', $data);
        } else {
            redirect('CLogin/logout');
        }
    ...
    public function detail_rencana_kelola($id)
    {
        if (isset($_SESSION['id_user'])) {
            $data['title'] = "Detail Kelola Perjadin";
            $data['notif'] = $this->admin_model->hitungNew();
            $data['rencana'] = $this->admin_model->getRencanaById($id);
            $this->load->view('headfoot/header', $data);
            $this->load->view('headfoot/navbar_dash_admin', $data);
            $this->load->view('admin/detail_kelola_perjadin', $data);
            $this->load->view('headfoot/footer', $data);
        } else {
            redirect('CLogin/logout');
        }
    ...
    public function tambah_laporan1($id)
    {
        if (isset($_SESSION['id_user'])) {
            $this->admin_model->proses_tambah_laporan();
            echo "<script>alert('Anda berhasil menambah data');</script>";
            redirect('CAdmin/detail_rencana_kelola/' . $id, 'refresh');
        } else {
            redirect('CLogin/logout');
        }
    }
    ...
    public function pengaturan_akun($id)
    {
        if (isset($_SESSION['id_user'])) {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                redirect('CAdmin/pengaturan_akun/' . $id, 'refresh');
            }
        } else {
            redirect('CLogin/logout');
        }
    ...
    public function klikNotif($id)
    {
        ...
        redirect('CAdmin/detail_riwayat/' . $id);
    }
    ...
    public function filterCetak()
    {
        if (isset($_SESSION['id_user'])) {
            ...
            $this->load->view('headfoot/header', $data);
            $this->load->view('headfoot/navbar_dash_admin', $data);
            $this->load->view('admin/form_filter');
            $this->load->view('headfoot/footer', $data);
        } else {
            redirect('CLogin/logout');
        }
    ...
    public function filterExport()
    {
        if (isset($_SESSION['id_user'])) {
            ...
            $this->load->view('headfoot/header', $data);
            $this->load->view('headfoot/navbar_dash_admin', $data);
            $this->load->view('admin/form_filter_export');
            $this->load->view('headfoot/footer', $data);
        } else {
            redirect('CLogin/logout');
        }
        ...
        if (isset($_SESSION['id_user'])) {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                if ($nama == 0) {
                    ...
                    $this->pdf->load_view('admin/pdf_perjadin_all', $data);
                } else {
                    ...
                    $this->pdf->set_option('isRemoteEnabled', true);
                    $this->pdf->load_view('admin/pdf_perjadin', $data);
                }
            }
        } else {
            redirect('CLogin/logout');
    ...
    public function prosesExport()
    {
        if (isset($_SESSION['id_user'])) {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $data['data'] = $this->admin_model->filterCetak();
                $this->pdf->load_view('admin/excel_perjadin', $data);
            }
        } else {
            redirect('CLogin/logout');
        }
