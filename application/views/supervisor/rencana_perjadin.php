                  ...
                  <div class="panel panel-primary filterable">
                      <div class="panel-heading">
                          ...
                          <div class="pull-right">
                              ...
                              <a href="<?= base_url(); ?>CSupervisor/tambah_rencana_perjadin" class="btn btn-info" style="float: right;">+ Tambah Data</a> <br><br>
                          </div>
                      </div>
                              ...
                              <?php
                                ...
                                foreach ($rencana as $r) { ?>
                                  <tr>
                                      ...
                                      <td>
                                          <a href="<?= base_url(); ?>CSupervisor/detail_rencana/<?= $r->id_rencana; ?>" class="btn btn-success">
                                              <i class="icon-medium icon-eye-open"></i></a>
                                          <!-- <a href="<?= base_url(); ?>CSupervisor/edit_rencana/<?= $r->id_rencana; ?>" class="btn btn-primary">
                                              <i class="icon-medium icon-pencil"></i></a> -->
                                          <a href="<?= base_url(); ?>CSupervisor/hapus_rencana/<?= $r->id_rencana; ?>" class="btn btn-danger" onclick="return confirm('Apakah Data ini akan dihapus? ?')">
