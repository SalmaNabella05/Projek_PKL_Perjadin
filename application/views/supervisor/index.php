              ...
              <div class="widget-content" style="overflow-y: auto; height: 210px;">
                <table class="table table-striped table-bordered">
                  ...
                  <?php foreach ($rencana as $r) { ?>
                    <tr>
                      <td><a href="<?= base_url(); ?>CSupervisor/detail_riwayat/<?= $r['id_rencana']; ?>"> <?php echo $r['nama']; ?> </a></td>
    ...
    $(document).ready(function() {
      ...
      var calendar = $('#calendar').fullCalendar({
        ...
        select: function(start, end, allDay) {
          ...
          $.ajax({
            url: "<?php echo base_url(); ?>CSupervisor",
            type: "POST",
            data: {
              title: title,
              start: start,
        ...
        editable: true,
        events: "<?php echo base_url(); ?>CSupervisor/getTanggal",
        eventClick: function(calEvent) {
          var id = calEvent.id;
          $.ajax({
            url: "<?php echo base_url(); ?>CSupervisor/getUserByIdEvent",
            type: "POST",
            data: {
              id: id
            },
