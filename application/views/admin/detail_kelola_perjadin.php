              ...
              <div class="widget widget-table action-table">
                  ...
                  <div class="widget-content">
                      <table class="table table-striped table-bordered">
                          ...
                          <form action="<?php echo base_url(); ?>CAdmin/tambah_laporan1/<?= $rencana['id_rencana']; ?>" method="post" enctype="multipart/form-data">
                              ...
                              <?php
                                $today = date("Y-m-d");
                                if ($rencana['tanggal_berangkat'] < $today && $rencana['tanggal_pulang'] < $today) { ?>
                                  <tr>
                                      <th>File</th>
