                  ...
                  <div class="panel panel-primary filterable">
                      <div class="panel-heading">
                          ...
                          <div class="pull-right">
                              <a href="<?= base_url(); ?>Operator/filterCetak" class="btn btn-info" style="float: right;"><i class="icon-print"> Cetak Data</i></a>
                              <a href="<?= base_url(); ?>Operator/filterExport" class="btn btn-warning" style="float: right;"><i class=" icon-share"> Export Data</i></a> <br><br> <br><br>
                          </div>
                      </div>
                              ...
                              <?php
                                ...
                                foreach ($rencana as $r) { ?>
                                  <tr>
                                      ...
                                      <td>
                                          <a href="<?= base_url(); ?>Operator/detail_riwayat/<?= $r->id_rencana; ?>" class="btn btn-success">
